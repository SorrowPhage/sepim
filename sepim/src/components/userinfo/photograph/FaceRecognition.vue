<template>
    <div>
        <div>
            <div class="input-btn">
                <button @click="getCompetence()">人脸识别登录</button>
            </div>
            <el-dialog
...
export default {
    ...
    methods: {
        ...
        faceLogin(){
            axios.post("http://localhost:8080/api/user/fare",{file:this.base64toFile(this.pre)},{headers: {'Content-Type': 'multipart/form-data'}}).then(res=>{
                if (res.data.flag === "200") {
